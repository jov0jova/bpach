...
def save_entry_logic(session_id, entry_logic, entry_mode, entry_logic_long="", entry_logic_short=""):
    return m.save_entry_logic(db_path(), session_id, entry_logic, entry_mode, entry_logic_long, entry_logic_short)
